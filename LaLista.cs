    ...
    internal class LaLista
    {
        ...
        public void establecernumeroequipos()
        {
            do
            {
                try
                {
                    Console.WriteLine("Ingrese el numero de equipos (6,8,10) que participaran en el Campeonato Los Sufridos:");
        ...
        public void PreguntarNombres()
        {
            ...
            do
            {
                do
                {
                    ...
                    aux = aux.ToUpper();
                    if (verificardisponibilidaddenombre(aux) == 0)
                    {
                        Console.WriteLine("El nombre: " + aux + " Ya esta usado\n");
                    }
                } while (verificardisponibilidaddenombre(aux) == 0);
        ...
        private int verificardisponibilidaddenombre(string nombrecito) //Retorna 1 si el nombre es valido y 0 si ya esta usado
        {
                foreach (Equipo equipoaux in Milista)
                {
                if (equipoaux != null) 
                {    
                    if (nombrecito == equipoaux.getNombre())
                    {
                        return 0;
                    }
                }
        ...
        public List<Partido> MostrarPartidos(Equipo[] milista)
        {
